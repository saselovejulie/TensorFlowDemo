...
from mnist.mnist_leNet5_optimize import mnist_train
...
def evaluate(mnist):
    with tf.Graph().as_default() as g:
        ...
        x = tf.placeholder(tf.float32,
                           [len(mnist.validation.images),  # 测试的样例的个数
        ...
        # 适应卷及神经网络
        reshaped_xs = np.reshape(mnist.validation.images, (len(mnist.validation.images), mnist_inference.IMAGE_SIZE, mnist_inference.IMAGE_SIZE, mnist_inference.NUM_CHANNELS))
